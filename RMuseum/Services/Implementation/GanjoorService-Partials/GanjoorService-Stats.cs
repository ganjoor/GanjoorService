...
namespace RMuseum.Services.Implementation
{
    ...
    public partial class GanjoorService : IGanjoorService
    {
        ...
        private async Task<string> _GetCategoryStatsPage( int poetId, int catId, List<GanjoorMetre> rhythms, RMuseumDbContext context)
        {
            ...
            htmlText += $" آمار <a role=\"button\" class=\"w3tooltip cursor-pointer\" onclick=\"switch_section('stats-section', 'stats-collapse-button')\"><i class=\"info-buttons collapse_circle_down\" id=\"stats-collapse-button\"></i><span class=\"w3tooltiptext\">جمع شود / باز شود</span></a>{Environment.NewLine}";
