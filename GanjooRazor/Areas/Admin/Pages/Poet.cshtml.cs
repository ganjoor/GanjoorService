        ...
        public async Task<IActionResult> OnPostEditPoetAsync(GanjoorPoetViewModel Poet)
        {
            ...
            using (HttpClient secureClient = new HttpClient(new GanjoorReloginHandler(Request, Response)))
            {
                ...
                else
                {
                    ...
                    LastResult = $"ویرایش انجام شد. <a role=\"button\" href=\"/Admin/Poet?id={System.Net.WebUtility.HtmlEncode(Request.Query["id"])}\" class=\"actionlink\">برگشت به صفحهٔ ویرایش سخنور</a>";
        ...
        public async Task<IActionResult> OnPostUploadImageAsync(IFormFile Image)
        {
            ...
            using (HttpClient secureClient = new HttpClient(new GanjoorReloginHandler(Request, Response)))
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    LastResult = $"تصویر بارگذاری شد. <a role=\"button\" href=\"/Admin/Poet?id={System.Net.WebUtility.HtmlEncode(Request.Query["id"])}\" class=\"actionlink\">برگشت به صفحهٔ ویرایش سخنور</a>";
        ...
        public async Task<IActionResult> OnPostUploadDbAsync(IFormFile SQLiteDb)
        {
            ...
            using (HttpClient secureClient = new HttpClient(new GanjoorReloginHandler(Request, Response)))
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    LastResult = $"پایگاه داده‌ها بارگذاری شد. <a role=\"button\" href=\"/Admin/Poet?id={System.Net.WebUtility.HtmlEncode(Request.Query["id"])}\" class=\"actionlink\">برگشت به صفحهٔ ویرایش سخنور</a>";
        ...
        public async Task<IActionResult> OnPostUploadCorrectionDbAsync(SQLiteCorrecionDbModel CorrecionDbModel)
        {
            ...
            using (HttpClient secureClient = new HttpClient(new GanjoorReloginHandler(Request, Response)))
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    LastResult = $"پایگاه داده‌های اصلاحی بارگذاری شد. <a role=\"button\" href=\"/Admin/Poet?id={System.Net.WebUtility.HtmlEncode(Request.Query["id"])}\" class=\"actionlink\">برگشت به صفحهٔ ویرایش سخنور</a>";
