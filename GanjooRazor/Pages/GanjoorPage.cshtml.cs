...
{
    /// <summary>
    /// Renders a single Ganjoor content page (poem/poet/category). Split out of IndexModel, which
    /// used to serve both this and the home page from one class dispatching on
    /// Request.Path == "/" - see _HomePagePartial.cshtml / _GanjoorPagePartial.cshtml, and
    ...
    public partial class GanjoorPageModel : LoginPartialEnabledPageModel
    {
        ...
        /// constructor
        /// </summary>
        public GanjoorPageModel(IConfiguration configuration,
        ...
        /// <summary>
        /// Get. Unlike the old IndexModel.OnGetAsync, this never needs to check
        /// Request.Path == "/" - routing guarantees this page never receives that request, since
        /// Index.cshtml's own automatic "/" route always takes precedence over this page's
        /// catch-all for a request to "/".
        /// </summary>
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            BuildTitleAndBreadCrumbs(breadCrumbList);
        ...
        /// URL and redirecting there. Also kept on IndexModel (home page): since query strings don't
        /// affect ASP.NET Core route matching, a link like "/?p=123" always has Path == "/" and is
        /// always routed to the home page regardless of this split, so the check needs to exist on
        /// both classes to keep old "?p=" links working from either entry point.
        /// </summary>
        ...
        /// <summary>
        /// Sets ViewData["Title"] and populates the breadcrumb list. Unlike the old
        /// BuildTitleAndBreadCrumbsAsync, has no IsHomePage branch - this class never serves the home
        /// page (see the note on OnGetAsync above).
        /// </summary>
        private void BuildTitleAndBreadCrumbs(GoogleBreadCrumbList breadCrumbList)
        {
            if (IsPoetPage)
            {
        ...
        // --- merged from the old _SimiPage.cshtml.cs (was a partial-class extension of IndexModel) ---
